  ...
  return (
    <div id='about' className='min-h-screen w-screen'>
        <div className="relative mb-8 mt-36 flex flex-col items-center justify-center gap-5">
            <h2 className="font-general text-sm uppercase special-font md:text=[10px]">Welcome to Zentry</h2>
            ...
            <div className="about-subtext">
                <p className="">The Game of Games begin-your life, now an epic MMORPG</p>
                <p className="">Zentry unites every player from countless games and platforms</p>
            </div>
        </div>
